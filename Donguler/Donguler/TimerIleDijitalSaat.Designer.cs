namespace Donguler
{
    partial class TimerIleDijitalSaat
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            label1.Location = new Point(338, 177);
            label1.Name = "label1";
            ...
            label2.Location = new Point(271, 177);
            label2.Name = "label2";
            ...
            Controls.Add(label2);
            Controls.Add(label1);
            Name = "TimerIleDijitalSaat";
            Text = "TimerIleDijitalSaat";
            Load += TimerIleDijitalSaat_Load;
            ResumeLayout(false);
            PerformLayout();
        }
